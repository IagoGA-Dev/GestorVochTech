                ...
                <div class="flex justify-between mb-4">
                    <div class="flex items-center gap-4">
                        <select wire:model.live="perPage"
                            class="border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm">
