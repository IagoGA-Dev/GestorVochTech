<div>
    <form wire:submit.prevent="createGrupo" class="space-y-6">
        <div>
            <label for="nome" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                <i class="fas fa-users mr-2"></i>Nome do Grupo
            </label>
