    ...
    <header
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                <div class="flex-shrink-0 group p-2 rounded-full bg-gradient-to-r from-green-400 to-green-600 dark:from-green-500 dark:to-green-700">
                    <h1 class="text-2xl font-bold text-green-600 dark:text-green-400">Gestão<span
                            class="text-green-400 dark:text-green-300">Pro</span></h1>
                </div>
    ...
    <main class="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        ...
        <div class="max-w-4xl mx-auto text-center mb-24">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="/grupos"
                    class="inline-flex items-center px-8 py-4 bg-green-600 hover:bg-green-700 text-white rounded-lg shadow-lg transition-all transform hover:-translate-y-1">
        ...
        <!-- Seção: Recursos -->
        <section
            class="py-16 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
